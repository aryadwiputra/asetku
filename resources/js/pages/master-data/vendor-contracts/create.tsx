...
export default function CreateVendorContract() {
    ...
    return (
        <>
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl px-4 py-4 sm:px-6 sm:py-6">
                ...
                <Form {...toForm(VendorContractController.store())} className="max-w-2xl space-y-6">
                    {({ processing, errors }) => (
                        <>
                            <Card className="space-y-4 p-6">
                                ...
                                <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                                    <div className="grid gap-2">
                                        ...
                                        <Input id="sla_response_hours" name="sla_response_hours" type="number" min={1} />
                                    ...
                                    <div className="grid gap-2">
                                        ...
                                        <Input id="sla_resolution_hours" name="sla_resolution_hours" type="number" min={1} />
