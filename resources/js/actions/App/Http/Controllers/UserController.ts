...
* @see app/Http/Controllers/UserController.php:214
* @route '/users/{user}'
*/
...
/**
* @see \App\Http\Controllers\UserController::bulkAction
* @see app/Http/Controllers/UserController.php:233
...
const UserController = { index, create, store, show, edit, update, destroy, bulkAction, exportMethod, export: exportMethod }
