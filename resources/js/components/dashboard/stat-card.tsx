...
export function StatCard({ title, value, description, icon, trend, className }: StatCardProps) {
  return (
    <div className={cn("bg-card ring-1 ring-border rounded-xl p-6 flex flex-col transition-all shadow-sm hover:ring-black/10 dark:hover:ring-white/10", className)}>
